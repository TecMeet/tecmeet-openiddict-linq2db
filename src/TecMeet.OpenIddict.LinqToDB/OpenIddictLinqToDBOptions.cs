...
/// the OpenIddict LinqToDB integration.
/// </summary>
public class OpenIddictLinqToDBOptions
{
    /// <summary>
    /// Gets or sets the concrete type of the <see cref="IDataContext"/> used by the
    /// OpenIddict LinqToDB stores. If this property is not populated,
